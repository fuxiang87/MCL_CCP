...
%*******START OF Option 1*******
        % Option 1: All the pixels in the neighbor edges for sampled space
        % to speed up
        lablist = lab_data(neighb_edge(:)==1,:);
        sampledColor = [sampledColor;lablist];
%*******END OF Option 1*******

%*******START OF Option 2*******
%       Option 2: Two typical cases are considered for sampled space
